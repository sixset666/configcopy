...
Функция ПолучитьОбязательныеРеквизиты(ДляЭлемента=Истина, ДляГруппы=Ложь) Экспорт
	...
	Если ДляЭлемента Тогда
		...
		ОбязательныеОпции.Вставить("КатегорияТранспортногоСредства",3);
		ОбязательныеРеквизиты.Вставить("ДиапазонЗначений",ОбязательныеОпции);
...
Функция ПроверитьКорректность(Ошибки="", ДопРеквизиты=Неопределено, Заполнение=Истина, Уникальность=Истина) Экспорт
	...
	//		Результат = Ложь;
	//		дкДобавитьОшибку(Ошибки,"Значение минимальное должно быть меньше или равно значению максимальному.");
	//	КонецЕсли;
	//	Для каждого СтрокаТЧ Из ДиапазонЗначений Цикл
	//		Если СтрокаТЧ.ЗначениеМин>СтрокаТЧ.ЗначениеМакс Тогда
	//			Результат = Ложь;
	//			дкДобавитьОшибку(Ошибки,"Диапазон значений требования (строка "+СтрокаТЧ.НомерСтроки+"): Значение минимальное должно быть меньше или равно значению максимальному.");
	//		КонецЕсли; 
	//	КонецЦикла;
	//КонецЕсли;
...
Процедура ПередЗаписью(Отказ)
	...
	//наименование формируем из полного наименования (обрезается до 150 символов)
	Если НЕ ЭтоГруппа Тогда
