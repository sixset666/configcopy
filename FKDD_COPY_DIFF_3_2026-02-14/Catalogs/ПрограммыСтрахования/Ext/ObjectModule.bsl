// Модуль справочника Программы страхования
...
Функция ПолучитьОбязательныеРеквизиты(ДляЭлемента=Истина, ДляГруппы=Ложь) Экспорт
	...
	ОбязательныеРеквизиты.Вставить("СтраховаяКомпания",1);
	ОбязательныеРеквизиты.Вставить("ВидСтрахования",1);
	ОбязательныеРеквизиты.Вставить("Вознаграждение",1);
