// Модуль справочника ГруппыТоваровОборудования
...
Функция ПолучитьОбязательныеРеквизиты(ДляЭлемента=Истина, ДляГруппы=Ложь) Экспорт
	...
	Если ДляЭлемента Тогда
		ОбязательныеТипы=Новый Структура();
		ОбязательныеТипы.Вставить("ТипГруппаНоменклатуры",3);
		
		//ОбязательныеРеквизиты.Вставить("КоличествоЯчеек",1);
		ОбязательныеРеквизиты.Вставить("ОграниченияЗаполненияГруппы",ОбязательныеТипы);
	КонецЕсли;
