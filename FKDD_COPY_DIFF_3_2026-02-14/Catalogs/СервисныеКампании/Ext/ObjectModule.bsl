// Модуль справочника СервисныеКампании
	...
	ИначеЕсли Имя="ВариантКомплектации" Тогда
		...
		Если НЕ обЗначениеНеЗаполнено(ВариантКомплектации) Тогда
			Если Модель<>ВариантКомплектации.Владелец Тогда
				...
				Рез=ОбработкаРеквизита("Модель",ТекСтрока,ЭтаФорма,ДопПараметры);
			КонецЕсли; 
		КонецЕсли; 
		Возврат Рез;
		
	Иначе Возврат спОбработкаРеквизита(ЭтотОбъект,Имя,ТекСтрока,ЭтаФорма,ДопПараметры);
	КонецЕсли;
