...
Функция ПолучитьОбязательныеРеквизиты(ДляЭлемента=Истина, ДляГруппы=Ложь) Экспорт
	...
	Если ВариантНастройки = Перечисления.СпособыМиграцииОбъектов.ИндивидуальнаяНастройкаПоПодразделениямИУзлам Тогда
		ОбязательныеРеквизиты.Вставить("ВариантНастройки",1);
	Иначе	
		ОбязательныеРеквизиты.Вставить("ВариантНастройки",2);
	КонецЕсли; 
