...
Процедура ПриОткрытии(Отказ)    
	...
	Элементы.Category.СписокВыбора.ЗагрузитьЗначения(ns_ДляБизнесаФормы.ПолучитьСписокКатегорий());
	Элементы.GoodsType.СписокВыбора.ЗагрузитьЗначения(ns_ДляБизнесаФормы.ПолучитьСписокПодкатегорий(Category));  
...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	ns_ОбщегоНазначенияФормы.ОбработкаВыбора(Элементы, ВыбранноеЗначение, ИсточникВыбора, "ns_ДляБизнеса"); 
КонецПроцедуры
...
Процедура СброситьРеквизитыЗаполнения(ОчищатьCategory = Ложь, ОчищатьGoodsType = Ложь)
	...
	ConditionДляБизнеса = Неопределено; 
	...
	Попытка
		...
		Для каждого СтрокаСписка Из ВыделенныеСтроки Цикл
			Если СтрокаСписка.ЭтоГруппа Тогда
				...
				|ГДЕ
				|	ns_ДляБизнеса.Родитель В ИЕРАРХИИ(&Родитель)
				|	И ns_ДляБизнеса.ЭтоГруппа = ЛОЖЬ";
...
Процедура УстановитьЗначениеЭлементу(Ссылка, ЗначенияСопоставленныхРеквизитов)
	...
	ns_ОбщегоНазначенияВызовСервера.УстановитьНовоеЗначениеРеквизита(Изменен, ТекущийОбъект, "Condition", ConditionДляБизнеса);
...
Процедура УстановитьВыгружать(Команда)
	ns_ОбщегоНазначенияФормы.УстановитьВыгружать(Элементы, Истина, "ns_ДляБизнеса");
КонецПроцедуры

&НаКлиенте
Процедура СнятьВыгружать(Команда)
	ns_ОбщегоНазначенияФормы.УстановитьВыгружать(Элементы, Ложь, "ns_ДляБизнеса");
КонецПроцедуры
...
Процедура ОбновитьСписокНаСервере()
	...
	Список.ТекстЗапроса = ns_Переопределяемый.ПолучитьТекстЗапроса_ДляБизнеса(Склад);
...
Процедура СнятьБезОстатковСВыгрузкиНаСервере()
	ns_АвитоВалидация.СнятьБезОстатковСВыгрузки("ns_ДляБизнеса");
КонецПроцедуры
