...
Функция ПолучитьОбязательныеРеквизиты(ДляЭлемента=Истина, ДляГруппы=Ложь) Экспорт
	...
	Если ДляЭлемента Тогда
		ОбязательныеРеквизиты.Вставить("Шаблон", 1);
		
		ОбязательныеСоответствиеРеквизитовИЗамен = Новый Структура;
		//ОбязательныеСоответствиеРеквизитовИЗамен.Вставить("Имя", 3);
		ОбязательныеСоответствиеРеквизитовИЗамен.Вставить("Мнемоника", 3);
		
		ОбязательныеРеквизиты.Вставить("СоответствиеРеквизитовИЗамен", ОбязательныеСоответствиеРеквизитовИЗамен);
	КонецЕсли;
...
Процедура ОбработкаЗаполнения(Основание)
	Если ТипЗнч(Основание) = Тип("Структура") Тогда
		Если Основание.ОбъектМетаданных="ЗаявкаНаРемонт" Или Основание.ОбъектМетаданных="ЗаказНаряд" Тогда
			ЭтотОбъект.ТипОбъектаМетаданных=Основание.ТипОбъектаМетаданных;
			ЭтотОбъект.ОбъектМетаданных=Основание.ОбъектМетаданных;
			ЭтотОбъект.Наименование=Основание.Наименование;	
		КонецЕсли;
	КонецЕсли;
