...
Функция ПолучитьОбязательныеРеквизиты(ДляЭлемента=Истина, ДляГруппы=Ложь) Экспорт
	...
	Если ЭтотОбъект.Ссылка <> Справочники.ТипыМаркировки.ИзделияИзМеха
		И ЭтотОбъект.Ссылка <> Справочники.ТипыМаркировки.ЛекарственныеПрепараты Тогда
		ОбязательныеРеквизиты.Вставить("Наименование", 1);
		ОбязательныеРеквизиты.Вставить("ТоварнаяГруппа", 1);
		ОбязательныеРеквизиты.Вставить("КодТоварнойГруппы", 1);
	КонецЕсли;
