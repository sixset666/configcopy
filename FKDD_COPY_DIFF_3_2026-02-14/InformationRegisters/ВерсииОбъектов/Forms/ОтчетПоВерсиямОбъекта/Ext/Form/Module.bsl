...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЦветСветлоСерый = ЦветаСтиля.ТекстПредупреждающейНадписи;
	ЦветКрасноФиолетовый = ЦветаСтиля.ЦветВажного;
...
Процедура Сформировать()
	...
	Иначе
		ОбщегоНазначенияКлиентСерверБСП.УстановитьСостояниеПоляТабличногоДокумента(Элементы.ТаблицаОтчета, "ФормированиеОтчета");
...
Процедура ПриЗавершенииФормированияОтчета(Результат, ДополнительныеПараметры) Экспорт
	Если Результат = Неопределено Тогда
		Возврат;
	КонецЕсли;
	ОбщегоНазначенияКлиентСерверБСП.УстановитьСостояниеПоляТабличногоДокумента(Элементы.ТаблицаОтчета, "НеИспользовать");
