...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("СформироватьПриОткрытии") и Параметры.Свойство("Вариант",НастройкиВарианта) Тогда
		Если не НастройкиВарианта = Неопределено Тогда
			...
			ОтчетОбъект = Отчеты.БТ_ОтчетПоВизитам2.Создать();
...
Функция РасшифрокаПоЗН(СтруктураЗначений);//Период,Показатель)
	...
	Отчет2 = РеквизитФормыВЗначение("Отчет");
	СКД = Отчет2.ПолучитьМакет("ОсновнаяСхемаКомпоновкиДанных").ВложенныеСхемыКомпоновкиДанных.Найти("Расшифровка").Схема;
...
Процедура ВыборФайлаЗавершение(ВыбранныеФайлы, ДополнительныеПараметры) Экспорт
	...
	Если ВыбранныеФайлы <> Неопределено Тогда
		...
		Отчет.ИмяФайла = ВыбранныеФайлы[0];
