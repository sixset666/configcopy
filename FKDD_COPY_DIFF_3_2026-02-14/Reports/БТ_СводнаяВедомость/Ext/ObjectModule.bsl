...
Процедура УстановитьПараметры()
	...
	//ЧалапАю БизТех 30.05.2025
	//ГарантийныйЗН = Справочники.ВидыРемонта.НайтиПоКоду("ЦБ000010");  
	СЗВидовРемонта = Новый СписокЗначений();
	СЗВидовРемонта.Добавить(Справочники.ВидыРемонта.НайтиПоКоду("ЦБ000010"));
	СЗВидовРемонта.Добавить(Справочники.ВидыРемонта.НайтиПоКоду("ЦБ000050"));

	КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ГарантийныйЗН", СЗВидовРемонта);
