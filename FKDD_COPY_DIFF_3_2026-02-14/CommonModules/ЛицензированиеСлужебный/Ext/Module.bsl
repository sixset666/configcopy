...
//	КлиентскиеОбработчики["СтандартныеПодсистемы.БазоваяФункциональность\ПередНачаломРаботыСистемы"] .Добавить("ЛицензированиеСлужебный");
//	КлиентскиеОбработчики["СтандартныеПодсистемы.БазоваяФункциональность\ПриЗавершенииРаботыСистемы"].Добавить("ЛицензированиеСлужебный");
//	
//	// События возникающие в контексте Сервера
//	СерверныеОбработчики["СтандартныеПодсистемы.БазоваяФункциональность\ПриДобавленииОбработчиковУстановкиПараметровСеанса"].Добавить("ЛицензированиеСлужебный");
...
//	
//	Если НЕ(ИмяПараметра="ТекущийАдресСервераЛицензирования" ИЛИ ИмяПараметра="АдресСервераЛицензирования" ИЛИ ИмяПараметра="СписокСертификатов" ИЛИ ИмяПараметра="МестоХраненияКомпоненты" ИЛИ ИмяПараметра="ВключенаЗащитаОтОпасныхДействий") Тогда
//		Возврат;
//	КонецЕсли;
//	
