...
Функция ПолучитьСписокПечатныхФорм(ДокументСсылка) Экспорт
	...
	СтруктураМакетов.Вставить("ПеремещениеДенежныхСредств"                , "Перемещение денежных средств");
	СтруктураМакетов.Вставить("ПеремещениеДенежныхСредствНаРасчетныйСчет" , "Перемещение денежных средств на расчетный счет");
