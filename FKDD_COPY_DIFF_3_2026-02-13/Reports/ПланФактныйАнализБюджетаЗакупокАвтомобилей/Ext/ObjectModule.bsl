...
////////////////////////////////////////////////////////////////////////////////
// ПЕРЕМЕННЫЕ ОБЪЕКТА
Перем ТекстЗапроса Экспорт;                            // текст запроса отчета
...
Перем тзРасширенныйСписокПоказателей;                  // таблица с расширенным набором показателей
...
// Корректировака таблицы заголовка
