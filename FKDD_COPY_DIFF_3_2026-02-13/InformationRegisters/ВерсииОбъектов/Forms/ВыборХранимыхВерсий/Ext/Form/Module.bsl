...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПереходНаВерсиюРазрешен = РольДоступна("ПолныеПрава") И Не ТолькоПросмотр;
...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("ЦветТекста", ЦветаСтиля.АльтернативныйЦветФонаПоля);
	...
	Шрифт = ШрифтыСтиля.ШрифтВажнойНадписи;
