...
Процедура ПередЗаписью(Отказ)
	...
	Для каждого СтрокаПользователя Из Пользователи Цикл
		Если НЕ ЗначениеЗаполнено(СтрокаПользователя.Пользователь) Тогда
			Сообщить("Не выбран пользователь для получения напоминания. Строка "+СтрокаПользователя.НомерСтроки+".");		
			Отказ=Истина;
		Иначе
			СтрокиПользователя=Пользователи.НайтиСтроки(Новый Структура("Пользователь",СтрокаПользователя.Пользователь));
			Если СтрокиПользователя.Количество()>1 Тогда
				Сообщить("Не уникальный пользователь """+СтрокаПользователя.Пользователь+""". Строка "+СтрокаПользователя.НомерСтроки+".");		
				Отказ=Истина;
			КонецЕсли; 
		КонецЕсли; 
	КонецЦикла; 
...
Процедура ОбработкаЗаполнения(Основание)
	ОбменМоделями=Истина;
	ОбменКонтрагентами=Истина;
	ОбменАвтомобилями=Истина;
	ОбменЦенами=Истина;
	ОбменТО=Истина;
