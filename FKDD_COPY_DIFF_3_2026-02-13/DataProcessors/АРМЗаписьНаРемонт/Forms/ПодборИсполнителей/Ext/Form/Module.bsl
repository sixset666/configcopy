...
Функция ВыполнитьПодборИсполнителей()
	...
	Возврат ПоместитьВоВременноеХранилище(ТаблицаРезультат.ВыгрузитьКолонку("Исполнитель"));
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	схемаКомпановкиДанных = Обработки.АРМЗаписьНаРемонт.ПолучитьМакет("СКД_ПодборИсполнителей");
