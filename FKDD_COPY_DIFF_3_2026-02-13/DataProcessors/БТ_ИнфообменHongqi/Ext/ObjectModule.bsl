...
Функция СписокКонстантныхЗначенийОбработки()
	...
	КонсЗнач.Вставить("РегистрСопоставления",РегистрыСведений.БТ_СопоставлениеДанныхHongqi);
	КонсЗнач.Вставить("РегистрСопоставленияВидовРемонта",РегистрыСведений.БТ_СопоставлениеВидовРемонтаHongqi);
	КонсЗнач.Вставить("РегистрСопоставленияПодразделений",РегистрыСведений.БТ_СопоставлениеПодразделенийHongqi);
