...
Функция ПолучитьОбязательныеРеквизиты(ДляЭлемента=Истина, ДляГруппы=Ложь) Экспорт
	...
	ОбязательныеРеквизиты.Вставить("Синонимы", ОбязательныеСинонимы);
	...
	ОбязательныеРеквизиты.Вставить("ДонорыАртикулов", УникальныеДоноры);
...
Функция ОбработкаРеквизита(Имя,ТекСтрока=Неопределено,ЭтаФорма=Неопределено,ДопПараметры=Неопределено) Экспорт
	...
	Если Имя="АртикулыОбязательны" Тогда
		Если АртикулыОбязательны И
			НаименованияУникальны Тогда
			НаименованияУникальны = Ложь;
			ОбработкаРеквизита("НаименованияУникальны");
		КонецЕсли;	
	Иначе	
...
Процедура ОбработкаЗаполнения(Основание)
	...
	Если ЭтоНовый() Тогда
		...
		Родитель = Справочники.Производители.ПустаяСсылка();
	КонецЕсли;	
...
Процедура ПриЗаписи(Отказ)
	...
	Если Не Отказ Тогда
		атСервер.ИзменитьПроизводителяВРегистреПрайсЛистыКонтрагентов(, Наименование, Ссылка);
	КонецЕсли;
