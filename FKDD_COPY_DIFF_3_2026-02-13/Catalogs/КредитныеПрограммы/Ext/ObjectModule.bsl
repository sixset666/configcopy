// Модуль справочника КредитныеПрограммы
...
Функция ПолучитьОбязательныеРеквизиты(ДляЭлемента=Истина, ДляГруппы=Ложь) Экспорт
	...
	ОбязательныеРеквизиты.Вставить("ГодоваяСтавка",1);
	//KamikadZe begin add 23.08.2018 19:31:15
	ОбязательныеРеквизиты.Вставить("БанкКонтрагент",1);
	ОбязательныеРеквизиты.Вставить("АгентскаяУслуга",1);
	//KamikadZe end add
